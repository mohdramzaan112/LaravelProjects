  ...
  <nav class="navbar navbar-default" role="navigation">  
    <div class="container">
      <div class="navbar-header">
        ...
        <!-- LOGO -->              
        <!-- TEXT BASED LOGO -->
        <!-- <a class="navbar-brand" href="{{ url('/') }}"><i class="fa fa-university"></i><span>OmarWeb</span></a> -->
        <!-- IMG BASED LOGO  -->
        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('public/img/logo.png') }}" alt="logo" height="330%" style="display:inline;"><span>OmarWeb</span></a>
      </div>
      <div id="navbar" class="navbar-collapse collapse">
        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
          <li class="active"><a href="{{ url('/') }}">Home</a></li>            
          <li><a href="{{ url('/blog-archive') }}">Blogs</a></li>
